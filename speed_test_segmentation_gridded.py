...
outputClumps='test_gridded_clumps2.kea'
outputMeanImg='test_gridded_clumps2_mean.kea'

#segutils.runShepherdSegmentation(inputImage, outputClumps, outputMeanImg, minPxls=100)
tiledsegsingle.performTiledSegmentation(inputImage, outputClumps, outputMeanImg, minPxls=100)
