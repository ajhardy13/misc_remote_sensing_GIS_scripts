...
'''
inputImg = '/Users/Andy/Documents/Zambia/RemoteSensing/Sentinel_1/GRD/Out/Subset/S1B_IW_GRDH_1SDV_20170704T165718_Sigma0_stack_lee.tif'
outputClumps=inputImg.split('.')[0]+'_clumps2.kea'
outputMeanImg = inputImg.split('.')[0]+'_clumps2_mean.kea'
# output classified image
outimage=inputImg.split('.')[0]+'_clumps2_classified_multi_svm_unbalanced_allstats_wetveg.tif'
