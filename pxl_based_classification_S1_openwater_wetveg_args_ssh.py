...
outputClumps=inputImg.split('.')[0]+'_chboard.kea'    # name cf clumps image

# output classified image
outimage=inputImg.split('.')[0]+'_chboard_erf_mode.tif'
...
waterMask='/Users/Andy/Documents/Zambia/RemoteSensing/WB_classification/Supporting_data/global_surface_water/seasonality_barotseland_snapped_'+inputImg.split('/')[-1].split('_')[4]+'_clump_clust5_m18dB.shp'
vegwaterMask='/Users/Andy/Documents/Zambia/RemoteSensing/WB_classification/Supporting_data/global_surface_water/seasonality_barotseland_snapped_'+inputImg.split('/')[-1].split('_')[4]+'_clump_clust5_wetveg.shp'
##############################################################################################
...
variables = ['VVAvg','VHAvg','VVdivVHAvg']
