...
outSnap=outClass.replace('.tif','_snap.kea')
...
permWater='/Users/Andy/Documents/Zambia/RemoteSensing/Sentinel_1/GRD/Out/Subset/2017/classified_stack_2017_occurrence_v2_perm_water.kea'
...
bandDefns.append(BandDefn('urban', guf, 1))
...
'''
for inImg in list:
	inClass=inImg.replace('.tif','_clumps2_erf_clumptrain_mode_otsu_snap_guf.kea')
	outClass=inClass.replace('.kea','_permW.kea')
	#add permanent water
	bandDefns = []
	bandDefns.append(BandDefn('class', inClass, 1))
	bandDefns.append(BandDefn('permWater', permWater, 1))
	condition='(permWater==1)?1:class'
	imagecalc.bandMath(outClass, condition, gdalformat, rsgislib.TYPE_8UINT, bandDefns)