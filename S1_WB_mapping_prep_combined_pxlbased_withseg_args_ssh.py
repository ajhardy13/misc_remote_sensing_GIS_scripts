...
clumps=inputImage.split('.')[0]+'_grid_clumps2.kea'
...
water_in=waterSnap
radar_in=inputImage
outName=waterSnap.replace('.tif','_clust5_m18dB.tif')
outShp=waterSnap.replace('.tif','_clust5_m18dB.shp')
...
water_in=waterSnap
radar_in=inputImage
outName=waterSnap.replace('.tif','_clust5_wetveg.tif')
outShp=waterSnap.replace('.tif','_clust5_wetveg.shp')
