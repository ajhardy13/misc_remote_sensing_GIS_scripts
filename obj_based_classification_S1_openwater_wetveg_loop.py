...
listFiles = glob.glob('*20170318T165713*_lee.tif')
...
for inputImg in listFiles:
	...
	#otherMask='/mnt/Data/AndyHardy/Projects/Zambia/Supporting_data/SRTM/barotseland_srtm_utm_lee_slope_gt1_5_wgs84.shp'
	#waterMask='/mnt/Data/AndyHardy/Projects/Zambia/Supporting_data/global_surface_water/seasonality_barotseland_snapped_'+inputImg.split('/')[-1].split('_')[4]+'_m18dB.shp'
	#vegwaterMask='/mnt/Data/AndyHardy/Projects/Zambia/Supporting_data/global_surface_water/seasonality_barotseland_snapped_'+inputImg.split('/')[-1].split('_')[4]+'_wetveg.shp'
